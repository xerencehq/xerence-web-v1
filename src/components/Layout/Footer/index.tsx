...
import { staggerContainerVariant, staggerItemVariant, fadeInUpVariant } from '@/styles';
import {
  FOOTER_LINKS,
  SOCIAL_LINKS,
  CONTACT_INFO,
    ...
    <FooterWrapper data-testid="footer">
      <FooterContainer>
            ...
            <FooterColumn as={motion.div} variants={staggerItemVariant}>
              ...
              <ColumnList>
                {FOOTER_LINKS.company.map((link) => (
                  <li key={link.href}>
                    <ColumnLink as={Link} href={link.href}>
                      {link.label}
                    </ColumnLink>
                  </li>
                ))}
        ...
        <FooterBottom>
          ...
          <LegalLinks>
            <LegalLink as={Link} href="/privacy">
              Privacy Policy
            </LegalLink>
            <LegalLink as={Link} href="/terms">
              Terms of Service
            </LegalLink>
          </LegalLinks>
        </FooterBottom>
