  ...
  return (
    ...
    >
      <InfoSection>
        <InfoItem>
          ...
          <InfoContent>
            ...
            <InfoValue>
              <a href="mailto:hello@xerence.com">hello@xerence.com</a>
            </InfoValue>
          </InfoContent>
        </InfoItem>
        ...
        <InfoItem>
          ...
          <InfoContent>
            ...
            <InfoValue>Remote-first, Global</InfoValue>
          </InfoContent>
        </InfoItem>
      </InfoSection>
      ...
      <InfoSection>
        ...
        <SocialLinks>
          <SocialLink
            href="https://twitter.com/xerence"
            target="_blank"
          ...
          <SocialLink
            href="https://linkedin.com/company/xerence"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
          >
